        ...
        <el-form
            ...
            <input id="laoshiId" name="laoshiId" type="hidden">
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.kechengFile" label="附件" prop="kechengFile">
                        <file-upload
                                tip="点击上传附件"
                                action="file/upload"
                                :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.kechengFile" label="附件" prop="kechengFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.kechengFile"  >附件下载</a>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
